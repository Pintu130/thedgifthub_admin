      ...
      <div className="space-y-4 text-[#333]">
        <div className="px-2 mb-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold tracking-tight text-customButton-text">Edit Product</h1>
              <p className="text-sm text-[#7A6C53] mt-1">Update product information</p>
            </div>
            <button
