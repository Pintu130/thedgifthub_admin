...
//   // utility: format ISO date (or return '-')
//   const formatDate = (val?: any) => {
//     if (!val) return "-"
//     try {
//       // val could be Firestore Timestamp or ISO string or Date
//       if (val?.toDate) {
//         const d = val.toDate()
...
//   // ✅ Fetch users (with defaults for missing fields)
//   const fetchUsers = useCallback(async () => {
//     setIsLoading(true)
//     setIsError(false)
//     try {
...
//           lastOrderDate: raw.lastOrderDate ?? raw.last_order_date ?? "",
...
//       supportRequestCount: user.supportRequestCount ?? 0,
...
//   // ✅ Column Definitions (added new columns)
//   const columnDefs: ColDef[] = [
//     { headerName: "First Name", field: "firstName", flex: 1, sortable: true, filter: true, minWidth: 120, maxWidth: 200 },
//     { headerName: "Last Name", field: "lastName", flex: 1, sortable: true, filter: true, minWidth: 120, maxWidth: 200 },
//     { headerName: "Email", field: "email", flex: 1.5, sortable: true, filter: true, minWidth: 220, maxWidth: 300 },
//     { headerName: "Phone", field: "phoneNumber", flex: 1, sortable: true, filter: true, minWidth: 150, maxWidth: 200 },
//     { headerName: "City", field: "city", flex: 1, sortable: true, filter: true, minWidth: 150, maxWidth: 200 },
//     { headerName: "Order Count", field: "orderCount", flex: 0.8, sortable: true, filter: true, minWidth: 120, maxWidth: 150, valueGetter: (p: any) => p.data?.orderCount ?? 0 },
//     {
...
//       minWidth: 140,
//       maxWidth: 180,
//       cellRenderer: (p: any) => <span>{formatDate(p.value)}</span>
//     },
//     { headerName: "Wishlist", field: "wishlistCount", flex: 0.8, sortable: true, filter: true, minWidth: 120, maxWidth: 150, valueGetter: (p: any) => p.data?.wishlistCount ?? 0 },
//     { headerName: "Support Tickets", field: "supportRequestCount", flex: 0.9, sortable: true, filter: true, minWidth: 140, maxWidth: 170, valueGetter: (p: any) => p.data?.supportRequestCount ?? 0 },
//     {
//       headerName: "Status",
...
//       minWidth: 120,
//       maxWidth: 150,
//       cellRenderer: (p: any) => <span className="capitalize">{p.value || "inactive"}</span>
//     },
//     {
//       headerName: "DOB",
//       field: "dateOfBirth",
...
const UsersData = () => {
  ...
  const columnDefs: ColDef[] = [
    ...
    { headerName: "City", field: "city", flex: 1, minWidth: 120 },
    { headerName: "Orders", field: "orderCount", flex: 0.7, minWidth: 120 },
    { headerName: "Status", field: "activityStatus", flex: 0.8, minWidth: 100 },
    {
      headerName: "Actions",
      field: "action",
      flex: 1,
      ...
      cellRenderer: (params: any) => (
        <div className="h-full flex items-center justify-center gap-2">
          <button
            onClick={() => setViewUser(params.data)}
